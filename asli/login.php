...
<body>
  <center>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="index.php">JOKER</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="Registrasi.php">Mahasiswa</a>
          <a class="dropdown-item" href="regisperusahaan.php">Perusahaan</a>
    ...
    <br><br>
    <label class="he text-white">SIGN IN</label>
    <hr class="garis">
    <div class="shadow-lg p-3 col-md-3 bg-white rounded" id="form1" style="border: 3px solid white !important;">
      <form  action="" method="POST" >
        ...
        <div class="form-group col-md-9">
          ...
          <button type="submit" class="btn btn-outline-dark" name="btnlogin" value="login" >Masuk</button>
