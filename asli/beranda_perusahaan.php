	...
	<div class="row">
		<div class="col-md-3">
			<div class="card" style="width: 18rem;">
				  <div class="card-body">
				  	 <img src="unudlogo.png" width="100">
				  	 <div class="ctextatas">
				  	 	<center>
					    <p class="card-text">Halo <span class="font-weight-bold"><?php echo "$user"; ?></span> Anda Login Sebagai	Jobseeker.</p>
					    </center>
					    </div>
					  </div>
					  <ul class="list-group list-group-flush">
					    <li class="list-group-item">Cari lowongan kerja</li>
					    <li class="list-group-item">Lowongan rekomendasi</li>
					    <li class="list-group-item">Lamaran kerja</li>
					    <li class="list-group-item">Tawaran Kerja</li>
			...
			<h2 class="textkanan">List Pelamar</h2>
			<h5 class="textkanan1"></h5>
